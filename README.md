...
runtime fixes do not require regeneration. Regenerate when the guard reports a
contract mismatch, or when you want a fix that changes generated source. Rerun
`OpenAPI.client` or `OpenAPI.server` against your document and commit the new
file.
