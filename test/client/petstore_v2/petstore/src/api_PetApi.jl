...
function _oacinternal_add_pet(_api::PetApi, body::Pet; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", Nothing, "/pet", ["petstore_auth", ], body)
...
function add_pet(_api::PetApi, response_stream::Channel, body::Pet; _mediaType=nothing)
    _ctx = _oacinternal_add_pet(_api, body; _mediaType=_mediaType)
...
function _oacinternal_update_pet(_api::PetApi, body::Pet; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "PUT", Nothing, "/pet", ["petstore_auth", ], body)
    OpenAPI.Clients.set_header_accept(_ctx, [])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "application/xml", ] : [_mediaType])
    return _ctx
end
...
function update_pet(_api::PetApi, response_stream::Channel, body::Pet; _mediaType=nothing)
    _ctx = _oacinternal_update_pet(_api, body; _mediaType=_mediaType)
    OpenAPI.Clients.exec(_ctx, response_stream)
end
