...
function login_user_read(handler)
    function login_user_read_handler(req::HTTP.Request)
        ...
        openapi_params["username"] = OpenAPI.Servers.to_param(String, query_params, "username", required=true, style="", is_explode=false)
        openapi_params["password"] = OpenAPI.Servers.to_param(String, query_params, "password", required=true, style="", is_explode=false)
        req.context[:openapi_params] = openapi_params
