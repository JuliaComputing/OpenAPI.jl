...
# `public` syntax was added in Julia 1.11. Build the equivalent expression on
# supported runtimes that understand it without making this file unparseable
# on Julia 1.10. All names remain available through the OpenAPI namespace.
